...
config_1.task("accounts", "Prints the list of accounts", function (taskArgs, bre) { return __awaiter(void 0, void 0, void 0, function () {
    var accounts, _i, accounts_1, account;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bre.web3.eth.getAccounts()];
            case 1:
                accounts = _a.sent();
